...
<ul id="post-options">
		<li><a id="oprev" href="http://news.iwebkit.net/?p=95"/></li>
		<li><a id="omail" onclick="return confirm('Mail a link to this post?');" href="mailto:?subject=iWebKit Blog- New homepage!&amp;body=Check out this post:%20http://news.iwebkit.net/?p=96"/></li>
		<li><a id="otweet" onclick="$wptouch('#twitter-box').slideToggle(300);" href="javascript:return false;"/></li>
		<li><a id="obook" onclick="$wptouch('#bookmark-box').slideToggle(300);" href="javascript:return false;"/></li>
		<li><a id="osearch" href="javascript:var%20db=document.body,sb='%3Cspan%20style=\'background-color:#FFFF00;\'%3E',tm=prompt('Find%20text%20on%20this%20page:'),sm='/('+escape(tm)+')/gi',se='%3C/span%3E';void(db.innerHTML=db.innerHTML.replace(eval(sm),sb+'$1'+se));"/></li>
		<li><a id="otext" onclick="wptouch_toggle_text();" href="javascript:return false;"/></li>
		<li><a id="onext" href="http://news.iwebkit.net/?p=97"/></li>
		</ul>
<div id="footer">
